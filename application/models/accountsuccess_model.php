...
<table style="border-collapse:collapse" cellspacing="0" cellpadding="0" border="0" align="center">
	<tbody>
		<tr>
			...
			<a href="<?php echo base_url(); ?>assets/images/OSOS-WEB-LOGO.png" target="_blank">OSOS Admin Team</a>
			
			Please click <a href="<?php echo base_url(); ?>" target="_blank"> Login </a> to proceed further
